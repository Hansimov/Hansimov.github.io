...
ERNO.Cube.prototype.showLogo = function(){
	...
	cube.centers.hasColor( ERNO.WHITE ).cubelets[ 0 ].faces.forEach( function( face ){

		if( face.color === ERNO.WHITE ) face.element.querySelector( '.sticker' ).classList.add( 'stickerLogo' )
	})
}
